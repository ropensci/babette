...
file.copy(babette::get_path("anthus_aco_sub.fas"), "test_output_0.fas")
file.copy(babette::get_path("anthus_aco_sub.fas"), "my_fasta.fas")
file.copy(babette::get_path("anthus_aco_sub.fas"), "my_alignment.fas")
file.copy(babette::get_path("anthus_aco_sub.fas"), "anthus_aco.fas")
file.copy(babette::get_path("anthus_nd2_sub.fas"), "anthus_nd2.fas")
```
