...
`site_models` is the `bbt_run_from_model` argument 
to select one or more site models.
...
`clock_models` is the `bbt_run_from_model` argument 
to select one or more clock models.
...
`tree_priors` is the `bbt_run_from_model` argument 
to select one or more tree priors.
